...
export const Nohemi = localFont({
    src: [
        {
            path: "../fonts/nohemi/Nohemi-Light.woff",
            weight: '300',
            style: 'normal',
        ...
        {
            path: "../fonts/nohemi/Nohemi-Regular.woff",
            weight: '400',
            style: 'normal',
        },
        {
        ...
        {
            path: "../fonts/nohemi/Nohemi-Medium.woff",
            weight: '500',
            style: 'normal',
        },
        {
        ...
        {
            path: "../fonts/nohemi/Nohemi-SemiBold.woff",
            weight: '600',
            style: 'normal',
        },
        {
        ...
        {
            path: "../fonts/nohemi/Nohemi-Bold.woff",
            weight: '700',
            style: 'normal',
        },
        {
        ...
        {
            path: "../fonts/nohemi/Nohemi-ExtraBold.woff",
            weight: '800',
            style: 'normal',
        },
        {
        ...
        {
            path: "../fonts/nohemi/Nohemi-Black.woff",
            weight: '900',
            style: 'normal',
        },
        {
